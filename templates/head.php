...
<head>
	...
	<meta property="og:description" content="更多神鬼認證:傑森包恩電影資訊 活動說明 電影劇照請見→ "/> 

	<meta property="og:type" content='website'/>
	<?php if(isset($_GET['picture'])):?>
	<meta property="og:url" content="http://event.ck101.com/JasonBourne/?picture=<?php echo urlencode($_GET['picture']) ?>" />
	<meta property="og:image" content="<?php echo htmlspecialchars_decode($_GET['picture']);?>" />
	...
	<script src="wp-content/themes/nelson-made/dist/scripts/modernizr.js" type="text/javascript"></script>
	<script src="wp-content/themes/nelson-made/dist/scripts/detectizr.min.js" type="text/javascript"></script>	
